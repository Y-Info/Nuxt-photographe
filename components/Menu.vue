  ...
  >
    ...
    <nav id="colorlib-main-menu" role="navigation">
      <ul>
        ...
        <li v-if="$store.state.currentPage === 'Blog' || $store.state.currentPage === 'Article' || $store.state.currentPage === 'Category' " class="colorlib-active">
    ...
    <div class="colorlib-footer">
      ...
      <div class="d-flex justify-content-center">
        <ul class="d-flex align-items-center">
          ...
          <li class="d-flex align-items-center jusitfy-content-center">
            <a href="#"><i class="icon-instagram" /></a>
          </li>
          <li class="d-flex align-items-center jusitfy-content-center">
